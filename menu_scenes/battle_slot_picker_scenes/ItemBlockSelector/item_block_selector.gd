...
func _ready():
	...
	var item_blocks = [
		ItemBlockDTO.new(Stats.TurretColor.RED, Stats.BlockShape.O, 0, ItemBlockConstants.RED_TILE_ID),
		ItemBlockDTO.new(Stats.TurretColor.BLUE, Stats.BlockShape.O, 0, ItemBlockConstants.BLUE_TILE_ID),
		ItemBlockDTO.new(Stats.TurretColor.GREEN, Stats.BlockShape.O, 0, ItemBlockConstants.GREEN_TILE_ID)
	]
